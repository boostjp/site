...
| 発表者           | タイトル |
|------------------|----------|
| @cpp_akira       | Boost.Geometryに学ぶテンプレートライブラリの設計 |
| @uskz            | 関数プログラマの為のBoostとBoostユーザの為の関数プログラミング |
| @fadis_          | ContainerFacade |
| @decimalbloat    | テンプレートメタプログラミング as 式 |
| @hotwatermorning | PStade.OvenとEggの実装を読む |
| @egtra           | char32_tとBoost.Xpressiveと |
| @kikairoya       | 組み込みでこそC++を使う100の理由 |
| @redboltz        | Boost.Msmの使い方                |
| @wraith13        | C++ Tips 1 #include編            |
| @lapis_tw        | おみやげじゃんけん               |
...
- アフターケア ： [Boost.勉強会 #6 札幌で喋ってきた話というか関数が純粋で静的に強く型付けられていることの重要性というかプログラムを計算する話](http://d.hatena.ne.jp/uskz/20111107/p2)
