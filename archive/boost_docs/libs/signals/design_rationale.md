...
## <a id="user_connect">ユーザレベルの接続管理</a>
...
## <a id="plus_equals">接続インターフェース: += 演算子</a>
...
## <a id="trackable">`trackable` の論拠</a>
