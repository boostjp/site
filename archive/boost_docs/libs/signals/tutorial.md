...
## <a id="multiple_slots">複数スロットの接続</a>
...
## <a id="ordering_slots">スロット呼び出しグループの順序づけ</a>
...
## <a id="slot_arguments">スロットへの実引数</a>
...
## <a id="scoped">変数スコープによって管理された接続</a>
...
## <a id="passing_slots">スロットの受け渡し</a>
