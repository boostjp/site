...
## <a id="functions" href="#functions">関数</a>
```cpp
template <class Concept>
void function_requires();
```

## <a id="macros" href="#macros">マクロ</a>
```cpp
...
## <a id="basic-concepts" href="#basic-concepts">基本コンセプト・チェック用クラス</a>
```cpp
template <class T>
...
## <a id="iterator-concepts" href="#iterator-concepts">イテレータ･コンセプト･チェック用クラス</a>
```cpp
template <class Iter>
...
## <a id="function-object-concepts" href="#function-object-concepts">関数オブジェクト・コンセプト･チェック用クラス</a>
```cpp
...
## <a id="container-concepts" href="#container-concepts">コンテナ･コンセプト･チェック用クラス</a>
```cpp
template <class C>
...
## <a id="basic-archetype" href="#basic-archetype">基本原型クラス</a>
```cpp
...
## <a id="iterator-archetype" href="#iterator-archetype">イテレータ原型クラス</a>
```cpp
...
## <a id="function-object-archetype" href="#function-object-archetype">関数オブジェクト原型クラス</a>
```cpp
...
## <a id="container-archetype" href="#container-archetype">コンテナ原型クラス</a>
構築中
