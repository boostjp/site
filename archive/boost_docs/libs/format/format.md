...
## <a id="synopsis" href="#synopsis">概要</a>
...
## <a id="how-it-works" href="#how-it-works">どのように作用するか</a>
...
## <a id="sample-files" href="#sample-files">サンプルファイル</a>
...
### <a id="printf-format-specifications" href="#printf-format-specifications">printfフォーマット仕様</a>
...
### <a id="new-format-specifications" href="#new-format-specifications">新たなフォーマット仕様</a>
...
### <a id="differences-of-behavior-vs-printf" href="#differences-of-behavior-vs-printf">printfとの振る舞いの違い</a>
...
## <a id="user-defined-types-output" href="#user-defined-types-output">ユーザー定義型の出力</a>
...
## <a id="manipulators-and-the-internal-stream-state" href="#manipulators-and-the-internal-stream-state">マニピュレータと、内部的なストリーム状態</a>
...
## <a id="alternatives" href="#alternatives">代替手段</a>
...
## <a id="exceptions" href="#Exceptions">例外</a>
...
## <a id="extract" href="#extract">抜粋</a>
...
## <a id="rationale" href="#rationale">設計原理</a>
...
## <a id="credits" href="#credits">クレジット</a>
