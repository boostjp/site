...
- [#13121](https://svn.boost.org/trac10/ticket/13121) g++ 4.6でのリンクエラーを修正するため、標準アトミックを使用するための要件をg++ 4.7以上とした
...
- いくつかの現代的なPOSIXプラットフォームで、`sys/poll.h`ではなく`poll.h`を使用するよう変更
- MSVCでのインテリセンス検出を修正
