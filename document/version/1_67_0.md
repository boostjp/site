...
- FreeBSDでのコンパイルエラーを修正
    ...
    - [0002-Wave-Avoid-using-wrong-T_DIVIDE-on-BSDs.patch](https://github.com/boostorg/website/blob/master/patches/1_67_0/0002-Wave-Avoid-using-wrong-T_DIVIDE-on-BSDs.patch)- Pythonの自動リンクを修正
