...
- [#128](https://github.com/boostorg/fiber/issues/128) : `condition_variable::wait_for` を使っている場合に assert エラー `"! ctx->ready_is_linked()"` が起きる点を修正
- [#132](https://github.com/boostorg/fiber/issues/132) : ビルド時に `'stdexception' file not found` エラーが起きる不具合を修正
- [#141](https://github.com/boostorg/fiber/issues/141) : boost::fibers::async が例外を投げる問題に対応
- [#146](https://github.com/boostorg/fiber/issues/146) : remote-ready-queue spinlock に対する不要なロックを削除
- [#153](https://github.com/boostorg/fiber/issues/153) : `context::set_ready()` を `context::schedule()` に置き換えるようにドキュメントを修正
- [#154](https://github.com/boostorg/fiber/issues/154) : `[buffered|unbuffered]_channels` の iterator に関するドキュメントを追加
- [#155](https://github.com/boostorg/fiber/issues/155) : `this_fiber` が boost::fibers 名前空間のメンバとしてドキュメントに記されている (訳注: 正しくは `boost::` 名前空間の直下) 点を修正
- [#156](https://github.com/boostorg/fiber/issues/156) : `examples/barrier.hpp` を修正
- [#158](https://github.com/boostorg/fiber/issues/158) : `work_stealing` クラスを動作させるために、`BOOST_FIBERS_DECL` マクロを追加
- [#162](https://github.com/boostorg/fiber/issues/162) : タイムアウト待ちの場合に、use-counter (訳注: 正確には `use_count_` 内部変数) をインクリメントするルーチンを削除
- [#166](https://github.com/boostorg/fiber/issues/166) : `scheduler::schedule()` コンストラクタにおける `ctx->wait_is_linked()` アサーションを削除
- [#167](https://github.com/boostorg/fiber/issues/167) : future が作成された場合のみ、`shared_state::owner_destroyed()` を呼び出すように修正
- [#168](https://github.com/boostorg/fiber/issues/168) : ドキュメントが最新でなかったので追随
...
- バグ修正とPull Request
  * Trac ticket: [ticket 12092](https://svn.boost.org/trac10/ticket/12092), [ticket 12596](https://svn.boost.org/trac10/ticket/12596), [ticket 12597](https://svn.boost.org/trac10/ticket/12597), [ticket 12969](https://svn.boost.org/trac10/ticket/12969), [ticket 13058](https://svn.boost.org/trac10/ticket/13058), [ticket 13149](https://svn.boost.org/trac10/ticket/13149), [ticket 13170](https://svn.boost.org/trac10/ticket/13170)
  * Trac ticket: [ticket 13181](https://svn.boost.org/trac10/ticket/13181), [ticket 13371](https://svn.boost.org/trac10/ticket/13371), [ticket 13387](https://svn.boost.org/trac10/ticket/13387), [ticket 13398](https://svn.boost.org/trac10/ticket/13398), [ticket 13407](https://svn.boost.org/trac10/ticket/13407), [ticket 13435](https://svn.boost.org/trac10/ticket/13435), [ticket 13443](https://svn.boost.org/trac10/ticket/13443)
  * Pull request: [github test 112](https://github.com/boostorg/test/pull/112), [github test 118](https://github.com/boostorg/test/pull/118), [github test 121](https://github.com/boostorg/test/pull/121), [github test 122](https://github.com/boostorg/test/pull/122), [github test 125](https://github.com/boostorg/test/pull/125), [github test 127](https://github.com/boostorg/test/pull/127)
