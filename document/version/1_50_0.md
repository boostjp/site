...
- 無効な交差点を出力から除外した
- `multi_polygon`の`disjoint`が、不正に`true`を返してしまう問題を修正解決したチケット
...
- eUML : eUMLで遷移表としてのみ定義されたフロントエンドのためのよりよい構文。
	- <font color="red">注意：破壊的変更！</font>[http://www.boost.org/doc/libs/1_50_0/libs/msm/doc/HTML/ch03s04.html#eUML-composite-table](http://www.boost.org/doc/libs/1_50_0/libs/msm/doc/HTML/ch03s04.html#eUML-composite-table)
