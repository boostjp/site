...
## <a id="basic-vector-usage" href="#basic-vector-usage">ベクトルの基本操作</a>
...
## <a id="vector-length" href="#vector-length">ベクトルの長さを取得する</a>
...
## <a id="normalize" href="#normalize">ベクトルを正規化する</a>
...
## <a id="inner-product" href="#inner-product">2つのベクトルの内積を求める</a>
...
## <a id="angle" href="#angle">2つのベクトルが成す角度を求める</a>
